...
class pychControlWin(QtGui.QMainWindow):
    ...
    def onShowManualPdf(self):
        fileToOpen = os.path.abspath(os.path.dirname(__file__)) + '/doc/pychoacoustics_manual.pdf'
        QtGui.QDesktopServices.openUrl(QtCore.QUrl.fromLocalFile(fileToOpen))
    def onShowModulesDoc(self):
        fileToOpen = os.path.abspath(os.path.dirname(__file__)) + '/doc/modules/html/index.html'
        QtGui.QDesktopServices.openUrl(QtCore.QUrl.fromLocalFile(fileToOpen))
