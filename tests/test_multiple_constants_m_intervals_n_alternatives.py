...
class TestMultiple_ConstantsMIntervalsNAlternatives(unittest.TestCase):
    ...
    def testA(self):
        ...
        x = os.system(cmdStr)
        assert(x==0)
        storedRes = pd.read_csv(rootPath + "multiple_constants_m-intervals_n-alternatives/results/res_table.csv", sep=";")
        currRes = pd.read_csv(rootPath + "multiple_constants_m-intervals_n-alternatives/res_table.csv", sep=";")
        ...
        storedResProc = pd.read_csv(rootPath + "multiple_constants_m-intervals_n-alternatives/results/res_table_sess.csv", sep=";")
        currResProc = pd.read_csv(rootPath + "multiple_constants_m-intervals_n-alternatives/res_table_sess.csv", sep=";")
