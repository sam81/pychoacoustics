...
class TestUML(unittest.TestCase):
    def testGeometric(self):
        ...
        cmdStr = "python3 ../pychoacoustics.pyw -f" + rootPath + "UML/UML_geometric.prm -a -q -c --seed 2033 -r" + rootPath + "UML/"+resFileRoot  + ".txt"
        x = os.system(cmdStr)
        assert(x==0)
    ...
    def testArithmetic(self):
        ...
        cmdStr = "python3 ../pychoacoustics.pyw -f" + rootPath + "UML/UML_arithmetic.prm -a -q -c --seed 2033 -r" + rootPath + "UML/"+resFileRoot  + ".txt"
        x = os.system(cmdStr)
        assert(x == 0)
