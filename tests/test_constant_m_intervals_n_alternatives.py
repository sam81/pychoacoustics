...
class TestConstantMIntervalsNAlternatives(unittest.TestCase):
    ...
    def testA(self):
        ...
        cmdStr = "PYTHONPATH='/media/ntfsShared/lin_home/auditory/code/pychoacoustics_exp/:/media/ntfsShared/lin_home/auditory/code/pychoacoustics/' python3 ../pychoacoustics/__main__.py -f" + rootPath +  "constant_m-intervals_n-alternatives/constant_m-intervals_n-alternatives.prm -a -q -o --seed 1933 -r" + rootPath + "constant_m-intervals_n-alternatives/"+resFileRoot  + ".txt"
        x = os.system(cmdStr)
        assert(x==0)
