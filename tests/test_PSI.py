...
class TestPSI(unittest.TestCase):
    def testGeometric(self):
        ...
        cmdStr = "PYTHONPATH='/media/ntfsShared/lin_home/auditory/code/pychoacoustics_exp/:/media/ntfsShared/lin_home/auditory/code/pychoacoustics/' python3 ../pychoacoustics/__main__.py -f"+ rootPath+ "PSI/PSI_geometric.prm -a -q -o --seed 2033 -r" + rootPath + "PSI/"+ resFileRoot  + ".txt"
        x = os.system(cmdStr)
        assert(x==0)
    ...
    def testArithmetic(self):
        ...
        cmdStr = "PYTHONPATH='/media/ntfsShared/lin_home/auditory/code/pychoacoustics_exp/:/media/ntfsShared/lin_home/auditory/code/pychoacoustics/' python3 ../pychoacoustics/__main__.py -f" + rootPath + "PSI/PSI_arithmetic.prm -a -q -o --seed 2033 -r" + rootPath + "PSI/"+resFileRoot  + ".txt"
        x = os.system(cmdStr)
        assert(x==0)
