...
class TestSigDetectMulti(unittest.TestCase):
    ...
    def testA(self):
        ...
        cmdStr = "PYTHONPATH='/media/ntfsShared/lin_home/auditory/code/pychoacoustics/' python3 ../pychoacoustics/__main__.py -f" + rootPath +  "sig_detect_multi/sig_detect_multi.prm -a -q -o --seed 1933 -r" + rootPath + "sig_detect_multi/"+resFileRoot  + ".txt"
        x = os.system(cmdStr)
        assert(x==0)
