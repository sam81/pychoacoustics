...
class TestWeightedUpDown(unittest.TestCase):
    def testGeometric(self):
        ...
        currRes = pd.read_csv(rootPath + "weighted_up-down/res_geometric_table.csv", sep=";")
        ...
        storedResProc = pd.read_csv(rootPath + "weighted_up-down/results/res_geometric_table_sess.csv", sep=";")
        currResProc = pd.read_csv(rootPath + "weighted_up-down/res_geometric_table_sess.csv", sep=";")
    ...
    def testArithmetic(self):
        ...
        currRes = pd.read_csv(rootPath + "weighted_up-down/res_arithmetic_table.csv", sep=";")
        numpy.testing.assert_array_equal(currRes["threshold_arithmetic"], storedRes["threshold_arithmetic"])
        numpy.testing.assert_array_equal(currRes["SD"], storedRes["SD"])

        storedResProc = pd.read_csv(rootPath + "weighted_up-down/results/res_arithmetic_table_sess.csv", sep=";")
        currResProc = pd.read_csv(rootPath + "weighted_up-down/res_arithmetic_table_sess.csv", sep=";")
