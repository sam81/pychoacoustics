...
def initialize_wav_sameDifferent(prm):
    exp_name = QApplication.translate("","WAV Same/Different","")
...
def select_default_parameters_wav_sameDifferent(parent, par):
...
# def get_fields_to_hide_wav_sameDifferent(parent):

#     pass


def doTrial_wav_sameDifferent(parent):
    ...
    if parent.currentCondition == 'same':
        parent.correctButton = 1
    elif parent.currentCondition == 'different':
